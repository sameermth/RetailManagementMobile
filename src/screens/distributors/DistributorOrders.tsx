...
const DistributorOrdersScreen = () => {
  ...
  const { orders, loading, fetchOrders } = useDistributors();
  ...
  const renderOrder = ({ item }: { item: any }) => (
    <TouchableOpacity
      ...
      onPress={() => navigation.navigate('DistributorOrderDetail', { orderId: item.id })}
    >
      ...
      <View style={styles.orderDetails}>
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailText}>
            Expected: {item.expectedDeliveryDate ? formatDate(item.expectedDeliveryDate) : 'Not set'}
          </Text>
        </View>
        <View style={styles.detailRow}>
  ...
  const renderHeader = () => (
    <View style={styles.header}>
      ...
      <View style={styles.filterTabs}>
        ...
        <TouchableOpacity
          style={[styles.filterTab, filterStatus === 'PENDING_APPROVAL' && styles.filterTabActive]}
          onPress={() => setFilterStatus('PENDING_APPROVAL')}
        >
          <Text style={[styles.filterTabText, filterStatus === 'PENDING_APPROVAL' && styles.filterTabTextActive]}>
            Pending
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        <TouchableOpacity
          style={[styles.filterTab, filterStatus === 'SHIPPED' && styles.filterTabActive]}
          onPress={() => setFilterStatus('SHIPPED')}
        >
          <Text style={[styles.filterTabText, filterStatus === 'SHIPPED' && styles.filterTabTextActive]}>
            Shipped
          </Text>
        </TouchableOpacity>
      </View>
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyStateText}>
        Create your first order for this distributor
      </Text>
      <TouchableOpacity
