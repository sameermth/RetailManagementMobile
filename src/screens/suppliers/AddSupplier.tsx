        ...
        >
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.section}>
                    ...
                    {renderInput('name', 'Supplier Name', 'Enter supplier name', { required: true })}
                    {renderInput('businessType', 'Business Type', 'Enter business type (e.g., Manufacturer, Distributor)')}
                </View>
                ...
                <View style={styles.section}>
                    ...
                    {renderInput('taxRegistrationNumber', 'Tax Registration Number', 'Enter tax registration number')}
                </View>
                ...
                <View style={styles.section}>
                    ...
                    {renderInput('leadTimeDays', 'Lead Time (days)', 'Enter average delivery time', {
                        keyboardType: 'numeric'
                    })}
                    ...
                    {renderInput('maximumOrderValue', 'Maximum Order Value', 'Enter maximum order value', {
                        keyboardType: 'numeric'
                    })}
                </View>
